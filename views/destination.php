...
<h1 class="heading mb-5 text-white" data-aos="fade-up">Popular Places</h1>
...
<div class="col-lg-6">
<h2 class="heading">Special offers &amp; Discounts</h2>
<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-5">
            <div class="media-1">
              <a href="" class="d-block mb-3"><img src="./views/assets/images/item1.jpg" alt="Image" class="img-fluid"></a>
        <div class="d-flex">
        <div>
        ...
        <span>520</span>
                ...
                <span class="d-flex align-items-center loc">
                </span>
                </div>
                </div>
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-5">
                <div class="media-1">
                <a href="#" class="d-block mb-3"><img src="./views/assets/images/insta7.jpg" alt="Image" class="img-fluid"></a>
                <div class="d-flex">
                <div>
                ...
                <span>520</span>
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-5">
                        <div class="media-1">
                        <a href="#" class="d-block mb-3"><img src="./views/assets/images/ITEM10.jpg" alt="Image" class="img-fluid"></a>
                        <div class="d-flex">
                        <div>
...
<div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-5">
                        <div class="media-1">
                        <a href="#" class="d-block mb-3"><img src="./views/assets/images/pexels-pixabay-271619.jpg" alt="Image" class="img-fluid"></a>
                        <div class="d-flex">
                        <div>
...
<!-- Mirrored from preview.colorlib.com/theme/hotell/destination.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Jun 2022 18:20:16 GMT -->
</html>