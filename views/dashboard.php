                        ...
                        <div class="col-lg-4  col-md-5  mb-4 ">
                            <div class="p-3  d-flex justify-content-around align-items-center card_cours ">
                                <div>
                                    ...
                                    <p class="fs-5 mb-5 Secondary-text">Chambre</p>
                                </div>
