    ...
    <div class="page-wrapper">
        ...
        <div class="page-header navbar navbar-fixed-top">
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="index.php">
                    <img alt="" src="views/assets/img/logo1.png">
                        ...
                        <!-- end message dropdown -->
 						...
 						<li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <img alt="" class="img-circle " src="views/assets/img/dp.jpg" />
	                            ...
	                            <div class="user-panel">
	                                <div class="row">
                                            <div class="sidebar-userpic">
                                                <img src="views/assets/img/dp.jpg" class="img-responsive" alt=""> </div>
                                        </div>
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.php">ACCUEIL</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
					        ...
					        <div class="col-xl-3 col-md-6 col-12">
					          <div class="info-box bg-success">
					            ...
					            <div class="info-box-content">
					              ...
					              <span class="info-box-number"> DH</span><span>  </span>
												...
												<tbody>
													...
													<tr>
														...
														<td>
															...
															<a class="btn btn-tbl-delete btn-xs" href="" >
        ...
        <div class="page-footer">
            <div class="page-footer-inner">  &copy; Kairali Resort
  By
