                ...
                <div class="row ">
                    <div class=" d-flex justify-content-between my-3">
                        ...
                        <div>
                            ...
                            <a href="./ajouterChambre"> <button type="button" class="btn fw-bold  fs-6" style="background:#ECB390 ; color: #012970;">Ajouter nouvelle chambre</button></a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form method="post" class="mr-1" action="updatechambre">
                                        ...
                                        <td>
                                            <form method="post" class="mr-1" action="deletechambre">
                                                <input type="hidden" name="id" value="<?php echo $chambre['id']; ?>">
                                                <button class="btn btn-sm ">
