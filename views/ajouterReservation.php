                ...
                <div class="card bg-light shadow p-4" style="display:flex;">
                  <form action="" method="POST">
                    <div class="row gy-4">
                      ...
                      <div class="col-md-6">
                        <input type="text" name="name" class="form-control" placeholder="Nom Complet" value="" required>
                      </div>
                      ...
                      <div class="col-md-6 ">
                        <input type="email" class="form-control" name="email" placeholder="votre addresse email" value="" required>
                      </div>
                  ...
                  <div class="account mb-5">
                    <div class="card text-dark bg-light mb-5" style="max-width: 18rem;">
                      ...
                      <div class="card-body ">
                        <ul>
                          <li>
                            <h5>Single:</h5>400.00/jour
                          </li>
                          <li>
                            <h5>Double:</h5>800.00/jour
                          </li>
                          <li>
                            <h5>Deluxe:</h5>1000.00/jour
                          </li>
                          <li>
                            <h5>Twin:</h5>8000.00/jour
                          </li>
                        </ul>
                      </div>
                    </div>
