        ...
        <div class="menu-bg-wrap">
            <div class="site-navigation">
                <div class="row g-0 align-items-center">
                    <div class="col-2">
                        <a href="home" class="logo m-0 float-start text-white">Hotel</a>
                    </div>
...
<div class="hero overlay" style="background-image:url(./views/assets/images/insta3.jpg)">
<div class="container">
<div class="row align-items-center justify-content-center">
<div class="col-lg-8 text-center">
<h1 class="heading text-white" data-aos="fade-up">Our Services</h1>
<p class="text-white-50 w-75 mx-auto" data-aos="fade-up" data-aos-delay="100">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
</div>
</div>
</div>
</div>
            ...
            <div class="features-slider" id="features-slider">
				<div class="item">
                    <div class="feature bg-color-1">
                        <span class="flaticon-trekking"><ion-icon name="restaurant"></ion-icon></span>
                        <h3>RESTAURANT</h3>
                ...
                <div class="item">
                    <div class="feature bg-color-3">
                        <span class="flaticon-suitcase"><ion-icon name="car-sport"></ion-icon></span>
                        <h3>
                           TRANSPORT</h3>
                        <p class="text-black-50">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    </div>
                ...
                <div class="item">
                    <div class="feature bg-color-4">
                        <span class="flaticon-suitcase"><ion-icon name="wifi-outline"></ion-icon></span>
                        <h3>WIFI GRATUIT</h3>
                        <p class="text-black-50">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    </div>
                </div> 
...
<img src="./views/assets/images/ITEM9.jpg" alt="Image" class="img-fluid img-box-shadow rounded">
</div>
<div class="col-lg-4 align-self-center" data-aos="fade-left" data-aos-delay="100">
<h2 class="heading mb-4">Why Us</h2>
                    ...
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col-2 text-end">
                            ...
                            <a href="#" class="call-us d-flex align-items-center">
                                <span class="icon-phone"><ion-icon name="call-outline"></ion-icon>
                                </span>
        ...
        <div class="container">
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-3">
                    <div class="widget">
                        ...
                        <ul class="list-unstyled links mb-4">
                            ...
                            <li><a href="tel://11234567890">+1(123)-456-7890</a></li>
                            <li><a href="https://preview.colorlib.com/cdn-cgi/l/email-protection#7811161e173815011c1715191116561b1715"><span class="__cf_email__" data-cfemail="0e676068614e63776a61636f6760206d6163">[email&#160;protected]</span></a></li>
                        </ul>
                        <h3>Connect</h3>
            ...
            <div class="row mt-5">
                <div class="col-12 text-center">
                        ...
                        </script> All rights reserved | This template is made with <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="https://colorlib.com/" target="_blank" rel="nofollow noopener">Colorlib</a></p>
                </div>
            </div>
        </div>
    </div>
...
<!-- Mirrored from preview.colorlib.com/theme/hotell/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Jun 2022 18:20:16 GMT -->
</html>