    ...
    <main>
        ...
        <div class="bg  " id="sidebar-dashboard" style="    height: 100vh;">
                ...
                <div class="list-group  d-flex ">
                    ...
                    <a href="resrvation" class="list-group-item mx-2 fw-bold  fs-6   border-0 my-2  rounded-3 p-2 ">
                        ...
                        <div class=" d-flex justify-content-between my-3">
                            ...
                            <div>
                                ...
                                <a href="./ajouterReservation"> <button type="button" class="btn fw-bold  fs-6"
                                        style="background:#DD10C9 ; color: #012970;">Ajouter nouveau reservation</button></a>
                            </div>
                        </div>
